...
absnos <- c(7,6,6,5,2,11,11,11,11,11)
percent <- c(71,43,43,36,14,100,100,100,100,100)
...
ylim(0,110)+
  labs(x="", y="",
       ...
       caption = "DataViz by Soundarya | Total Number of Publications =14")+
    coord_flip()+
    theme_classic()+
...
14. Soundararajan S, Murthy P. High Craving Is Associated with Fewer Abstinent Days and Lesser Time to Relapse During Treatment in Severe Alcohol Use Disorder. Indian Journal of Psychiatry (In Press)
...
13. Viramgami A, Soundararajan S, Sheth A, Upadhyay K. Validity of point-of-care device for diagnosing anemia in workers exposed to lead. Indian Journal of Community Health (In Press)
...
12. Determinants and Economic Consequences of Self Reported Illness Among Indian Construction Workers -- A Multicentre Study. ([Preprint](https://doi.org/10.21203/rs.3.rs-2376123/v1)) [@soundararajan2022]
