...
absnos <- c(19,15,19,9,3,24,24,24,24,24)
percent <- c(79,63,79,38,13,100,100,100,100,100)
...
ylim(0,110)+
  labs(x="", y="",
       ...
       caption = "DataViz by Soundarya | Total Number of Publications = 24")+
    coord_flip()+
    theme_classic()+
...
24. Soundararajan S, Muthu V. Creating Understandable and Accessible Data Visualizations in R. J Postgrad Med Edu Res 2026 [Online ahead of print](https://www.jpmer.com/journal/aop/JPMER/1)
...
23. The wisdom in mistakes - [A Science Career Article](https://www.science.org/careers/articles) [@Soundararajanwisdommistakes2026]

::: column-margin
`r fa("marker", fill = "#a984a1")`
:::
...
22. Reproducibility and Objectivity in Academic Research with R. [@soundararajan2025reproducibilityR]
...
17. Effort-reward imbalance, subjective sleep quality, and inflammation in female nurses at a tertiary hospital: a pilot study. [@singh2024sleepqualitypotentiala]
