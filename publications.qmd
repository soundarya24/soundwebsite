...
percent <- c(64,55,55,45,18,100,100,100,100,100)
...
df %>% 
  ...
  annotate("text",y=60,x=4.7, label="In 64% of my papers, I have contributed to Data Visualization")+
...
12. Elevated Stearoyl-CoA Desaturase 1 Activity Is Associated with Alcohol-Associated Liver Disease [@klepp2022elevatedstearoylcoadesaturase]
