...
<<<<<<< HEAD
absnos <- c(18,16,17,9,3,23,23,23,23,23)
percent <- c(78,70,74,39,13,100,100,100,100,100)
=======
absnos <- c(18,16,16,9,3,22,22,22,22,22)
percent <- c(82,73,73,41,14,100,100,100,100,100)
...
ylim(0,110)+
  labs(x="", y="",
       ...
       caption = "DataViz by Soundarya | Total Number of Publications = 22")+
    coord_flip()+
    theme_classic()+
...
23. The wisdom in mistakes [@Soundararajanwisdommistakes2026]
